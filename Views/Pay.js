...
const Pay = () => {
  return (
    <view style={{ flex: 1, }} >
      ...
      <view >
        <button style={{ width: 380, height: 40, borderWidth: 1, borderRadius: 5, margin: 7, backgroundColor: 'green' }} >
          <view><FontAwesomeIcon icon={faCreditCard} /><Text style={{ fontWeight: '600', marginLeft: '10' }}>Thêm thẻ</Text></view>
      ...
      <view style={{ flexDirection: "row", justifyContent: 'space-around', }}>
        <view style={{}}><button style={{ width: 120, height: 40, borderWidth: 1, borderRadius: 5, backgroundColor: 'white' }} >
          <view><FontAwesomeIcon icon={faCreditCard} /><Text style={{ fontWeight: '600', marginLeft: '20' }}>Nạp tiền</Text></view>
        </button></view>
